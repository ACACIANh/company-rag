...
| [0012](ADR-0012-document-index-sync.md) | 문서 인덱스 동기화 — 버전 스냅샷 + 최신 프로젝션 | 🟢 적용완료 (대폭 축소) |
...
| [0046](ADR-0046-individual-grant-dept-admin-delegation.md) | 개인 권한 부여/회수 + 부서 관리자 위임 | 🟣 대체됨 |
