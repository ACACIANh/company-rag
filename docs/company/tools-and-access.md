...
## 개발 환경
- AWS 계정: IAM 계정 발급 요청 (IT 포털)
- 로컬 개발: Docker 사용 (Docker Desktop 라이선스 회사 제공)
- CI/CD: GitHub Actions (팀 레포지토리에 자동 연동)

## 라이선스 소프트웨어
- JetBrains IDE (All Products Pack): IT팀에 신청
- Postman Team: 팀장 초대로 가입
- 1Password Teams: 입사 시 자동 초대
